...
void	queue(int sockfd, int sender, char *msg)
{
...
void	disconnect(int sockfd, int fd)
{
	char	msg[64];
...
int main(int ac, char **av)
{
 ...
 servaddr.sin_port = atoi(av[1]) >> 8 | atoi(av[1]) << 8;
